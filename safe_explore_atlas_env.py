#!/usr/bin/env python3
"""
SAFE READ-ONLY script to explore MongoDB Atlas BioGraph data using environment variables
...
def connect_to_atlas_safely():
    """Connect to MongoDB Atlas in read-only mode using environment variables"""
    ...
    database = os.getenv('MONGO_DATABASE', 'BioGraphDemo')
    
    if not all([username, password, cluster]):
        print("❌ Missing environment variables!")
        print("Please set the following environment variables:")
        print("  export MONGO_USERNAME='your_username'")
        print("  export MONGO_PASSWORD='your_password'")
        print("  export MONGO_CLUSTER='cluster0.abc123'")
        print("  export MONGO_DATABASE='BioGraphDemo'  # optional")
        print()
        print("Example:")
        print("  export MONGO_USERNAME='biograph_user'")
        print("  export MONGO_PASSWORD='your_password'")
        print("  export MONGO_CLUSTER='cluster0.abc123'")
        print("  python3 safe_explore_atlas_env.py")
        return None, None
    ...
    try:
        print(f"🔍 Connecting to: {cluster}.mongodb.net")
